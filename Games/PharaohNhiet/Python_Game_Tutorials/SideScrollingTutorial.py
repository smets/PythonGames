...
class Pharaoh(Actor):
    ...
    def update(self):
        ...
        if self.dx > 0 and self.x >= games.screen.width/2:
            for plat in self.game.platformList:
...
class Game(object):
    ...
    def __init__(self):
        ...
        platform = Platform(x = 42,
                            ...
                            hrd = True,
                            num = 10)
        platform2 = Platform(x = games.screen.width,
                             y = games.screen.height/3 * 2,
                             direction = "HORIZONTAL",
                             hrd = False,
                             num = 5)
